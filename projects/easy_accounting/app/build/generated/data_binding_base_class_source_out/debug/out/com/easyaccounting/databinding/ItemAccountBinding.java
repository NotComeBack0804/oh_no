...
public final class ItemAccountBinding implements ViewBinding {
  ...
  private ItemAccountBinding(@NonNull MaterialCardView rootView, @NonNull ImageView ivAccountIcon,
      @NonNull TextView tvAccountName) {
  ...
  public static ItemAccountBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemAccountBinding((MaterialCardView) rootView, ivAccountIcon, tvAccountName);
    }
