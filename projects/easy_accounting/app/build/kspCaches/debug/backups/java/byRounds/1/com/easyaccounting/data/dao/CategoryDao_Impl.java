...
public final class CategoryDao_Impl implements CategoryDao {
  ...
  public CategoryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCategory = new EntityInsertionAdapter<Category>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `categories` (`id`,`name`,`icon`,`type`,`isCustom`) VALUES (nullif(?, 0),?,?,?,?)";
      }
    ...
    this.__updateAdapterOfCategory = new EntityDeletionOrUpdateAdapter<Category>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `categories` SET `id` = ?,`name` = ?,`icon` = ?,`type` = ?,`isCustom` = ? WHERE `id` = ?";
      }
      ...
      public List<Category> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _tmpIsCustom = _tmp != 0;
            _item = new Category(_tmpId,_tmpName,_tmpIcon,_tmpType,_tmpIsCustom);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getCategoriesByTypeSync(final CategoryType type,
      ...
      public Category call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _tmp = _cursor.getInt(_cursorIndexOfIsCustom);
            _tmpIsCustom = _tmp != 0;
            _result = new Category(_tmpId,_tmpName,_tmpIcon,_tmpType,_tmpIsCustom);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Object getCategoryByNameAndType(final String name, final CategoryType type,
  ...
  @Override
  public Flow<List<Category>> getCustomCategories() {
    final String _sql = "SELECT * FROM categories WHERE isCustom = 1 ORDER BY name";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"categories"}, new Callable<List<Category>>() {
      @Override
      @NonNull
